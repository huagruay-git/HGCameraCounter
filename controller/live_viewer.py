...
class LiveViewerWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        top_controls.addWidget(QLabel("Camera:"))
        self.camera_combo = QComboBox()
        top_controls.addWidget(self.camera_combo)
        ...
        top_controls.addWidget(self.disconnect_btn)

        self.reload_zones_btn = QPushButton("Reload Zones")
        self.reload_zones_btn.clicked.connect(self.reload_current_zones)
        top_controls.addWidget(self.reload_zones_btn)
        top_controls.addStretch()
        layout.addLayout(top_controls)

        multi_controls = QHBoxLayout()
        self.multi_cameras_label = QLabel("Multi Cameras:")
        multi_controls.addWidget(self.multi_cameras_label)
        self.multi_camera_list = QListWidget()
        self.multi_camera_list.setMaximumHeight(90)
        self.multi_camera_list.setSelectionMode(QListWidget.NoSelection)
        multi_controls.addWidget(self.multi_camera_list, 1)
        ...
        layout.addWidget(self.single_video_label)
        ...
        self.multi_grid_container.setLayout(self.multi_grid)
        self.multi_grid_container.hide()
        layout.addWidget(self.multi_grid_container)

        snapshot_layout = QHBoxLayout()
        snapshot_layout.addWidget(QLabel("Recent Snapshots:"))
        self.snapshot_admin_list = QListWidget()
        self.snapshot_admin_list.setMaximumHeight(120)
        self.snapshot_admin_list.itemDoubleClicked.connect(self._open_selected_snapshot)
        snapshot_layout.addWidget(self.snapshot_admin_list, 1)

        snapshot_btn_col = QVBoxLayout()
        self.snapshot_open_btn = QPushButton("Open")
        self.snapshot_open_btn.clicked.connect(self._open_selected_snapshot)
        snapshot_btn_col.addWidget(self.snapshot_open_btn)
        ...
        snapshot_btn_col.addWidget(self.snapshot_mark_barber_btn)
        ...
        snapshot_btn_col.addWidget(self.snapshot_mark_customer_btn)
        ...
        snapshot_btn_col.addWidget(self.snapshot_mark_wash_customer_btn)
        snapshot_btn_col.addStretch()
        snapshot_layout.addLayout(snapshot_btn_col)
    ...
    def _on_view_mode_changed(self, mode_text: str):
        ...
        self.multi_cameras_label.setVisible(is_multi)
        self.multi_camera_list.setVisible(is_multi)
        self.multi_select_all_btn.setVisible(is_multi)
        self.multi_clear_btn.setVisible(is_multi)
        self.connect_multi_btn.setVisible(is_multi)
